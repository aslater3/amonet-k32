...
K32_WRAPPER_SHA256="${K32_WRAPPER_SHA256:-6fc1f50802632ba27653c7c54f8a195c4d245993baf8a987a29c3f58277a0f82}"
K32_BOOT_IMAGE="${K32_BOOT_IMAGE:-$WORKDIR/bin/boot-k32-native-evt.img}"
K32_BOOT_SHA256="${K32_BOOT_SHA256:-87c2b9dc27625775549fd687268dd810d42ac660d6d6f0b398dfc52c5a962535}"
