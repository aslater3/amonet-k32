...
K32_WRAPPER_SHA256="${K32_WRAPPER_SHA256:-b8883e47bed36dae0a1527456bbd6ddc1e0d67b91e7917f0b66202cb7c1e13a3}"
K32_BOOT_IMAGE="${K32_BOOT_IMAGE:-$WORKDIR/bin/boot-k32-native-evt.img}"
K32_BOOT_SHA256="${K32_BOOT_SHA256:-b7764a69ca00a3c38b80c09dfc1e6d644fd3510771c378df6ac47c91dd08afc4}"
