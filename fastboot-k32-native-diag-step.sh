...
K32_WRAPPER_SHA256="${K32_WRAPPER_SHA256:-7a1b548551537b918fb39cddd3b2a00ef380f819a40178bd2982d9c75b291c26}"
K32_BOOT_IMAGE="${K32_BOOT_IMAGE:-$WORKDIR/bin/boot-k32-native-evt.img}"
K32_BOOT_SHA256="${K32_BOOT_SHA256:-13922dcfdb045ba3b67f8709c395254ac7a3582e2819b545adf0f604dae31424}"
