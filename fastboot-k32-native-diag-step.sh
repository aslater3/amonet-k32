...
K32_WRAPPER_SHA256="${K32_WRAPPER_SHA256:-2b55df16df7ef46321a7b7be70662c13b36265e2f35646f00ad146757358c774}"
K32_BOOT_IMAGE="${K32_BOOT_IMAGE:-$WORKDIR/bin/boot-k32-native-evt.img}"
K32_BOOT_SHA256="${K32_BOOT_SHA256:-ceecf9d93f8f5a02c89525b0cd07044826046d0ee9766f0007e99e7db5ba896a}"
